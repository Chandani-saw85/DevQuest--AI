...
# 2. Clone your fork
git clone https://github.com/YOUR-USERNAME/DevQuest--AI.git

# 3. Add upstream
git remote add upstream https://github.com/Chandani-saw85/DevQuest--AI.git

# 4. Create feature branch from chandani-dev
git checkout chandani-dev
git pull upstream chandani-dev
...
# 6. Create Pull Request to chandani-dev
